...
This repository holds only the **built output** of a private source repository
(`ulysses-project`). Every push to the private source builds the site, verifies it
against the project's URL contract, and overwrites this repository — do not edit
...
Published addresses on this site do not change once minted; a broken link is treated as
